  ...
  return (
    <div className="font-sans min-h-screen bg-background text-foreground p-8">
      <main className="max-w-4xl mx-auto py-12">
        ...
        <section className="mb-8">
          <h2 className="text-h2 mb-4 text-text-primary">Color Palette</h2>
          
          {/* Primary Colors */}
          <div className="mb-6">
            <h3 className="text-h3 mb-3 text-text-primary">Primary Colors</h3>
          ...
          {/* Surface Colors */}
          <div className="mb-6">
            <h3 className="text-h3 mb-3 text-text-primary">Surface Colors</h3>
