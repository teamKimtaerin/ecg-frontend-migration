...
export default function DesignSystem() {
  return (
    <div className={`font-sans min-h-screen bg-background text-foreground ${getSpacingClass('MAIN_CONTAINER')}`}>
      <main className={`max-w-${DESIGN_SYSTEM_CONSTANTS.MAIN_CONTENT_MAX_WIDTH} mx-auto ${getSpacingClass('MAIN_CONTENT')}`}>
        ...
        <section className={getSpacingClass('SECTION')}>
          <h2 className={`text-h2 mb-${DESIGN_SYSTEM_CONSTANTS.SECTION_TITLE_MARGIN} text-text-primary`}>Typography</h2>
          
          {/* Font Sizes */}
          <div className={getSpacingClass('SUBSECTION')}>
            <h3 className={`text-h3 mb-${DESIGN_SYSTEM_CONSTANTS.BUTTON_GROUP_GAP} text-text-primary`}>Font Sizes</h3>
            <div className={`bg-surface ${getSpacingClass('CARD')} rounded-default border border-border ${getSpacingClass('DEMO_SUBSECTIONS')}`}>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-text-secondary">섹션 헤드라인 - SemiBold (600)</p>
              </div>
              <div>
                <h3 className="text-h3 text-text-primary">H3 (Medium) - 24px</h3>
                <p className="text-sm text-text-secondary">서브섹션 헤드라인 - SemiBold (600)</p>
              </div>
              <div>
              ...
              <div>
                <p className="text-caption text-text-secondary">Caption - 14px</p>
                <p className="text-sm text-text-secondary">캡션 텍스트 - Regular (400)</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={getSpacingClass('SECTION')}>
          <h2 className={`text-h2 mb-${DESIGN_SYSTEM_CONSTANTS.SECTION_TITLE_MARGIN} text-text-primary`}>Color Palette</h2>
          
          {/* Primary Colors */}
          <div className={getSpacingClass('SUBSECTION')}>
            <h3 className={`text-h3 mb-${DESIGN_SYSTEM_CONSTANTS.BUTTON_GROUP_GAP} text-text-primary`}>Primary Colors</h3>
            <div className={`grid grid-cols-${DESIGN_SYSTEM_CONSTANTS.GRID_COLS_MEDIUM} md:grid-cols-${DESIGN_SYSTEM_CONSTANTS.GRID_COLS_LARGE} ${getSpacingClass('GRID_GAP')}`}>
          ...
          {/* Surface Colors */}
          <div className={getSpacingClass('SUBSECTION')}>
            <h3 className={`text-h3 mb-${DESIGN_SYSTEM_CONSTANTS.BUTTON_GROUP_GAP} text-text-primary`}>Surface Colors</h3>
            <div className={`grid grid-cols-${DESIGN_SYSTEM_CONSTANTS.GRID_COLS_MEDIUM} md:grid-cols-${DESIGN_SYSTEM_CONSTANTS.SURFACE_GRID_COLS} ${getSpacingClass('GRID_GAP')}`}>
              ...
              <div className="bg-surface-secondary border border-border rounded-default p-4">
                <div className="font-semibold text-text-primary">Surface Secondary</div>
        ...
        {/* Component Sections */}
        <section className={`space-y-${DESIGN_SYSTEM_CONSTANTS.COMPONENT_SECTIONS_SPACING}`}>
          <ButtonDemo />
          <SwitchDemo />
          <DropdownDemo />
          <ProgressDemo />
