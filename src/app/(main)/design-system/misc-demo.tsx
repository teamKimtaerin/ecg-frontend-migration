...
const MiscDemo: React.FC = () => {
  const [sliderValue, setSliderValue] = useState<number>(DESIGN_SYSTEM_CONSTANTS.DEFAULT_SLIDER_VALUE);
  const [showAlert, setShowAlert] = useState(false);

  return (
    <div className={getSpacingClass('DEMO_SECTIONS')}>
      <div>
        <h2 className={`text-h2 mb-${DESIGN_SYSTEM_CONSTANTS.DEMO_HEADER_MARGIN} text-text-primary`}>Miscellaneous Components</h2>
      ...
      <div className={getSpacingClass('DEMO_SECTIONS')}>
        <div className={`${getSpacingClass('CARD')} bg-surface-secondary rounded-small`}>
          <h3 className={`text-h3 text-text-primary mb-${DESIGN_SYSTEM_CONSTANTS.SECTION_TITLE_MARGIN}`}>Tab Components</h3>
          <Tab>
            <TabItem id="home" label="Home">
              <div className={`p-${DESIGN_SYSTEM_CONSTANTS.SECTION_TITLE_MARGIN}`}>
                <h4 className={`font-medium mb-${DESIGN_SYSTEM_CONSTANTS.SUBSECTION_HEADER_MARGIN}`}>Home Content</h4>
                <p className="text-text-secondary">This is the home tab content.</p>
              </div>
            </TabItem>
            <TabItem id="profile" label="Profile">
              <div className={`p-${DESIGN_SYSTEM_CONSTANTS.SECTION_TITLE_MARGIN}`}>
                <h4 className={`font-medium mb-${DESIGN_SYSTEM_CONSTANTS.SUBSECTION_HEADER_MARGIN}`}>Profile Content</h4>
                <p className="text-text-secondary">This is the profile tab content.</p>
              </div>
            </TabItem>
            <TabItem id="settings" label="Settings">
              <div className={`p-${DESIGN_SYSTEM_CONSTANTS.SECTION_TITLE_MARGIN}`}>
                <h4 className={`font-medium mb-${DESIGN_SYSTEM_CONSTANTS.SUBSECTION_HEADER_MARGIN}`}>Settings Content</h4>
        ...
        <div className={`${getSpacingClass('CARD')} bg-surface-secondary rounded-small`}>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Basic Interactive Slider</h4>
              <p className="text-xs text-text-secondary">Drag to change value</p>
              <Slider
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Custom Range with Fill (20-80)</h4>
              <p className="text-xs text-text-secondary">Shows fill from start position</p>
              <Slider
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Gradient Fill Slider</h4>
              <p className="text-xs text-text-secondary">Interactive slider with gradient fill effect</p>
              <Slider
                label="Progress: 75%"
                minValue={0}
                maxValue={100}
            ...
            {/* Label Position Left */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Left Label Position</h4>
              <p className="text-xs text-text-secondary">Label positioned to the left of slider</p>
              <Slider
                label="Volume:"
                labelPosition="left"
                minValue={0}
            ...
            {/* Precision Slider */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">High Precision (0.1 step)</h4>
              <p className="text-xs text-text-secondary">Fine control with decimal values</p>
              <Slider
                label="Precision: 3.7"
                minValue={0}
                maxValue={10}
            ...
            {/* Logarithmic Scale */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Logarithmic Scale</h4>
              <p className="text-xs text-text-secondary">Non-linear progression for frequency ranges</p>
              <Slider
            ...
            {/* Read-only Slider */}
            <div className="space-y-3">
              <h4 className="text-body font-medium text-text-primary">Read-only Display</h4>
              <p className="text-xs text-text-secondary">Non-interactive slider for display purposes</p>
              <Slider
                label="CPU Usage: 65%"
                minValue={0}
                maxValue={100}
            ...
            {/* Disabled State */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Disabled State</h4>
              <p className="text-xs text-text-secondary">Disabled slider with reduced opacity</p>
              <Slider
            ...
            <div className="space-y-4">
              <h4 className="text-sm font-medium text-text-primary">Different Widths</h4>
              <p className="text-xs text-text-secondary">Sliders with varying widths</p>
              <div className="space-y-3">
                <Slider
                  label="Small (200px)"
                  minValue={0}
        ...
        <div className={`${getSpacingClass('CARD')} bg-surface-secondary rounded-small`}>
          ...
          <div className="space-y-6">
            {/* Variant Colors */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Badge Variants</h4>
              <p className="text-xs text-text-secondary">Different color variants for various use cases</p>
              <div className="flex gap-2 flex-wrap">
            ...
            {/* Size Variants */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Badge Sizes</h4>
              <p className="text-xs text-text-secondary">Different sizes for various contexts</p>
              <div className="flex gap-2 flex-wrap items-center">
                ...
                <Badge label="Extra Large" size="extra-large" variant="notice" />
              </div>
            </div>
            
            {/* With Icons */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Badges with Icons</h4>
              <p className="text-xs text-text-secondary">Icons can be used with or without labels</p>
              <div className="flex gap-2 flex-wrap items-center">
            ...
            {/* Rounding Options */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Badge Rounding</h4>
              <p className="text-xs text-text-secondary">Different border radius options</p>
              <div className="flex gap-2 flex-wrap items-center">
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Fixed Position Badges</h4>
              <p className="text-xs text-text-secondary">Badges that can be positioned relative to parent elements</p>
            ...
            {/* Complex Examples */}
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-text-primary">Complex Badge Examples</h4>
              <p className="text-xs text-text-secondary">Real-world usage examples</p>
              <div className="flex gap-2 flex-wrap items-center">
                <Badge label="v2.1.0" variant="gray" size="small" rounding="small" />
                <Badge icon={<StarIcon />} label="Premium" variant="yellow" />
                <Badge label="BETA" variant="orange" size="small" />
                <Badge label="Online" variant="positive" icon={<StarIcon />} rounding="full" />
