      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Complete end-to-end demonstration of video upload, processing, and transcription results.
            This demo shows the full workflow from file selection to emotion-analyzed subtitles.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-12 grid md:grid-cols-2 gap-8">
          ...
          <div className="p-6 bg-white rounded-lg shadow">
            ...
            <ul className="text-sm text-gray-700 space-y-2">
              ...
              <li>• <strong>Storage:</strong> AWS S3 with presigned URLs</li>
              <li>• <strong>Processing:</strong> Simulated ML pipeline</li>
              <li>• <strong>Real-time:</strong> HTTP polling for status</li>
              <li>• <strong>Demo Mode:</strong> Mock results for presentation</li>
            </ul>
          </div>
        </div>
      </div>
