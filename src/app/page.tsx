...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const refs = [heroRef, featuresRef, editRef, subtitleRef, votRef, libraryRef]
  ...
  return (
    <div className="font-sans min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      {/* Header */}
      <header className={`fixed top-0 w-full bg-black/90 border-b border-gray-slate/20 z-50 transition-transform duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-sm text-gray-medium font-bold hover:text-white transition-colors">
                Features
              </a>
              <a href="#open-library" className="text-sm text-gray-medium font-bold hover:text-white transition-colors">
                Open Library
              </a>
              <a href="#vot" className="flex items-center space-x-1 text-sm text-gray-medium font-bold hover:text-white transition-colors">
                <span>VoT</span>
              </a>
              <a href="#" className="text-sm text-gray-medium font-bold hover:text-white transition-colors">
                Login
              </a>
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="min-h-screen flex items-center justify-center px-6 pt-20 fade-in-section">
              ...
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex space-x-2">
                    ...
                    />
                    <Button variant="accent" size="medium" className="rounded-full px-6">
                      Sign up
                    </Button>
                  </div>
      ...
      <section ref={featuresRef} id="features" className="py-24 px-6 bg-primary-50 fade-in-section">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
            ...
            <div className="bg-black rounded-2xl p-4 border border-gray-slate/30">
              <div className="space-y-4">
                <div className="flex space-x-2">
                  ...
                  <span className="text-xs text-gray-medium ml-2">Style Options</span>
                </div>
      ...
      <section ref={editRef} className="py-24 px-6 bg-primary-50 fade-in-section delay-1">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <section ref={subtitleRef} className="py-24 px-6 bg-primary-50 fade-in-section delay-2">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-h1 font-black">
          ...
          <div className="relative">
            <div className="bg-black rounded-2xl p-6 border border-gray-slate">
              <div className="aspect-video bg-gray-slate rounded-lg p-4">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-medium text-sm">Waveform Editor</span>
                  ...
                  <div className="text-center">
                    <p className="text-white font-semibold">Put that <span className="text-status-fuchsia">coffee dOWn!</span> Coffee&apos;s for <span className="text-status-fuchsia">closers</span> only!</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* VoT Section */}
      <section ref={votRef} id="vot" className="py-24 px-6 fade-in-section delay-1">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 relative">
            <div className="bg-gray-slate/30 rounded-2xl p-6 border border-gray-slate/30">
              <div className="space-y-4">
                <div className="aspect-video bg-black rounded-lg p-3">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <div className="w-8 h-8 bg-red-600 rounded flex items-center justify-center text-white text-xs font-bold">LIVE</div>
                    ...
                    <div className="bg-gray-slate rounded p-3">
                      <p className="text-gray-medium text-xs">Latest trending video content...</p>
                    </div>
                  </div>
                </div>
                <div className="bg-black rounded-lg p-3">
                  <p className="text-white text-sm">Revolutionize your design process with NX immersive designer...</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div className="space-y-4">
              <h2 className="text-h1 font-black">
                <span 
                  className="block text-gray-medium text-h1">
                  VoT
                </span>
      ...
      <section ref={libraryRef} id="open-library" className="py-24 px-6 fade-in-section delay-2">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-h1 font-black">
              ...
              <p className="text-h3 text-gray-medium max-w-lg">
                ...
                <br/>or find exactly what your video needs!
              </p>
            </div>
            <Button 
              variant="accent" 
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-3">
                  <div className="bg-status-purple rounded-lg p-3 aspect-square flex items-center justify-center">
                    <span className="text-white font-bold text-sm">Mauvelous sparkle</span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="bg-status-informative rounded-lg p-3 aspect-square flex items-center justify-center">
                    <span className="text-white font-bold text-sm">Universal Theme</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-medium">
                Expressive Caption Generator platform for creating vibrant, emotion-driven subtitles.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">Fast Transcription</a>
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">Edit Transcription</a>
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">Subtitle Editor</a>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">VoT (Videos of Today)</a>
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">Open Library</a>
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">Trending</a>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">Documentation</a>
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">Help Center</a>
                <a href="#" className="block text-gray-medium hover:text-white transition-colors">Contact</a>
              </div>
            </div>
          </div>
