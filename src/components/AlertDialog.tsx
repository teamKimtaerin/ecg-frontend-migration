...
export type AlertDialogVariant = 'confirmation' | 'information' | 'warning' | 'destructive' | 'error';

export interface AlertDialogProps extends Omit<BaseComponentProps, 'isDisabled'> {
  title: string;
  description?: string;
